    ...
    <ScrollView
      refreshControl={
        <RefreshControl
          ...
          colors={[theme.colors.primary, theme.colors.text]} //cambia el color del signo a medida que pasa el tiempo, solo para android
          // style={{backgroundColor: '#5856D6'}} //cambia todo el backgroundcolor del espacio que esta utilizando el logo, solo ios CREO
          tintColor={theme.colors.text} //cambia el color del signo, solo para IOS
